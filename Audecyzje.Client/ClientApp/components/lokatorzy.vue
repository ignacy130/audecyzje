<template>
    <div id="roomers" class="subpage-view">
            ...
            <div class="row">
                 <div class="col-12 col-lg-8">
                    <h2 class="section-header">
                        Dotychczasowe błędy w szacowaniach
                    </h2>  
                </div>
                <div class="col-12 col-lg-8">
                    <p>
            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    <h2 class="text-header">
                        Skąd się wzięło ok. 55 000 lokatorów
                    </h2>  
                </div>
                <div class="col-12 col-lg-8">
                    <p>
